...
class CompatibilityTests
{
  ...
  private:
    static void testBackwardCompatibility()
    {
        ...
        const char* oldFormatUrl =
            "EOPFZARR:/vsicurl/https://objects.eodc.eu/"
            "e05ab01a9d56408d82ac32d69a5aae2a:202507-s02msil1c/15/products/cpm_v256/"
            "S2A_MSIL1C_20250715T104701_N0511_R051_T43XDJ_20250715T111222.zarr";

        std::cout << "  Testing old format: " << oldFormatUrl << std::endl;

        // Test driver identification
        GDALDriverH driver =
            GDALIdentifyDriverEx(oldFormatUrl, GDAL_OF_RASTER | GDAL_OF_READONLY, nullptr, nullptr);
        ...
        {
            std::cout << "    ⚠ Driver not identified (may be due to network/file issues)"
                      << std::endl;
        }
        ...
        {
            std::cout << "    ⚠ Could not open old format (expected for network issues)"
                      << std::endl;
        }
    ...
    static void testNewQuotedFormat()
    {
        ...
        const char* newFormatUrl =
            "EOPFZARR:\"/vsicurl/https://objects.eodc.eu/"
            "e05ab01a9d56408d82ac32d69a5aae2a:202507-s02msil1c/15/products/cpm_v256/"
            "S2A_MSIL1C_20250715T104701_N0511_R051_T43XDJ_20250715T111222.zarr/measurements/"
            "reflectance/r60m/b09\"";

        std::cout << "  Testing new format: " << newFormatUrl << std::endl;

        // Test driver identification
        GDALDriverH driver =
            GDALIdentifyDriverEx(newFormatUrl, GDAL_OF_RASTER | GDAL_OF_READONLY, nullptr, nullptr);
        ...
        {
            std::cout << "    ⚠ Could not open new format (expected for network issues)"
                      << std::endl;
        }
    ...
    static void testMixedFormats()
    {
        ...
        for (const auto& testCase : testCases)
        {
            ...
            // Test identification
            GDALDriverH driver = GDALIdentifyDriverEx(
                testCase.second.c_str(), GDAL_OF_RASTER | GDAL_OF_READONLY, nullptr, nullptr);
            ...
            if (driver)
            {
                ...
                {
                    std::cout << "    ⚠ Identified as different driver: " << driverName
                              << std::endl;
                }
            }
            else
    ...
    static void testQGISWorkflow()
    {
        ...
        if (rootDataset)
        {
            ...
            {
                std::cout << "  Step 2: Found subdatasets, simulating user selection..."
                          << std::endl;
        ...
        {
            std::cout << "    ⚠ Could not open root dataset (expected for network issues)"
                      << std::endl;
        }
