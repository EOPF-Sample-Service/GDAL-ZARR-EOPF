...
class PathParsingTests
{
  ...
  private:
    static void testUnquotedUrlParsing()
    {
        ...
        assert(
            result2 ==
            "/vsicurl/https://objects.eodc.eu/e05ab01a9d56408d82ac32d69a5aae2a:202507-s02msil1c/15/"
            "products/cpm_v256/S2A_MSIL1C_20250715T104701_N0511_R051_T43XDJ_20250715T111222.zarr");
    ...
    static void testQuotedUrlParsing()
    {
        ...
        std::string input1 =
            "EOPFZARR:\"/vsicurl/https://example.com/file.zarr/measurements/reflectance/r60m/b09\"";
        std::string result1 = ParseSubdatasetPath(input1);
        assert(result1 ==
               "/vsicurl/https://example.com/file.zarr/measurements/reflectance/r60m/b09");
    ...
    static void testEdgeCases()
    {
        ...
        // Test very long path
        std::string longPath =
            "/vsicurl/https://very.long.domain.name.example.com/very/long/path/with/many/segments/"
            "and/subdirectories/file.zarr/measurements/reflectance/very/deep/subdataset/path";
